...
export const navConfig: NavItem[] = [
  ...
  // ────────────────────────────────────────
  {
    ...
    subItems: [
      { key: 'assets', label: '资料库', href: '/customer/knowledge/assets', icon: FileStack, order: 1 },
      { key: 'evidence', label: '证据库', href: '/customer/knowledge/evidence', icon: ShieldCheck, order: 2 },
